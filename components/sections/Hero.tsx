    ...
    <section className="relative overflow-hidden px-6 pb-20 pt-5 md:px-12 md:pb-28">
      <div className="mx-auto max-w-6xl">
        <header className="flex items-center justify-between border-b border-[var(--color-shadow-mist)] pb-5">
          <a href="#top" className="flex items-center gap-3 font-semibold tracking-tight"><span className="grid size-9 place-items-center rounded-xl bg-[var(--color-marker-orange)] text-lg text-white">2B</span><span>Second Brain</span></a>
        ...
        <div id="top" className="grid items-center gap-14 py-20 md:py-28 lg:grid-cols-[1.05fr_.95fr]">
          <div>
            <p className="mb-6 font-mono text-xs uppercase tracking-[.22em] text-[var(--color-burnt-sienna)]">Android · offline-first · open source</p>
            <h1 className="max-w-3xl text-6xl font-semibold leading-[.95] tracking-[-.06em] md:text-8xl">Keep the thought.<br /><span className="text-[var(--color-marker-orange)]">Find it later.</span></h1>
            <p className="mt-8 max-w-xl text-lg leading-8 text-[var(--color-muted-foreground)] md:text-xl">Second Brain is a personal knowledge archive for the things you do not want to lose: links, notes, images, code, and voice memos.</p>
          ...
          <div className="relative mx-auto h-[440px] w-full max-w-[390px] sm:h-[520px]">
